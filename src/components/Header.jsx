...
export default function Header({ isDarkMode, onToggleMode }) {
  ...
  return (
    <header className="border-b border-[#1E2329]/10 bg-white/90 backdrop-blur transition-colors duration-300 ease-in-out dark:border-white/10 dark:bg-[#1E2329]/90">
